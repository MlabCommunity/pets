...
internal sealed class
    GetAllSheltersQueryHandler : IQueryHandler<GetAllSheltersQuery, Application.Dto.PagedResult<ShelterDto>>
{
    ...
    public async Task<Application.Dto.PagedResult<ShelterDto>> HandleAsync(GetAllSheltersQuery query,
