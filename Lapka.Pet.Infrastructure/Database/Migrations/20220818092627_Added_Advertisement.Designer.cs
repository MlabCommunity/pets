...
namespace Lapka.Pet.Infrastructure.Database.Migrations
{
    ...
    [Migration("20220818092627_Added_Advertisement")]
    partial class Added_Advertisement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lapka.Pet.Core.Entities.AdvertisementBase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lapka.Pet.Core.ValueObjects.PhotoId", b =>
                {
                    ...
                    b.Property<Guid?>("AdvertisementBaseId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AdvertisementBaseId");
            ...
            modelBuilder.Entity("Lapka.Pet.Core.ValueObjects.ShelterAdvertisement", b =>
                {
                    b.HasBaseType("Lapka.Pet.Core.Entities.AdvertisementBase");

                    b.Property<bool>("IsReserved")
                        .HasColumnType("boolean");

                    b.Property<Guid>("PetIdId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lapka.Pet.Core.ValueObjects.PhotoId", b =>
                {
                    b.HasOne("Lapka.Pet.Core.Entities.AdvertisementBase", null)
                        .WithMany("Photos")
                        .HasForeignKey("AdvertisementBaseId");
                });
            ...
            modelBuilder.Entity("Lapka.Pet.Core.ValueObjects.ShelterAdvertisement", b =>
                {
                    ...
                    b.HasOne("Lapka.Pet.Core.ValueObjects.PetId", "PetId")
                        .WithMany()
